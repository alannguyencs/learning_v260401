...
function AnswerBadge({ value }) {
  if (!value) return <span className="text-gray-500">&mdash;</span>;
  if (value === "correct")
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-gray-900 text-gray-400 text-left">
            ...
            <th className="px-3 py-3 font-medium">forgetting_rate</th>
          </tr>
        </thead>
        <tbody>
          {log.map((row, i) => (
            ...
            >
              ...
              <td className="px-3 py-2 text-gray-300">
                {row.book_id ?? <span className="text-gray-500">&mdash;</span>}
              </td>
              ...
              <td className="px-3 py-2 text-gray-300 text-center font-mono">
                {row.forgetting_rate != null ? (
                  row.forgetting_rate.toFixed(2)
                ) : (
                  <span className="text-gray-500">&mdash;</span>
                )}
              </td>
